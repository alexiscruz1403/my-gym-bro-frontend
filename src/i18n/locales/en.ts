const en = {
  ...
  notifications: {
    ...
    text: {
      ...
      postComment: '{{actor}} commented: "{{preview}}"',
      postCommentNoText: '{{actor}} commented on your post',
      newPost: '{{actor}} shared a new post',
      followRequest: '{{actor}} wants to follow you',
      followAccepted: '{{actor}} accepted your follow request',
      planSharedIndividual: '{{actor}} shared a plan with you',
      planSharedFollowers: '{{actor}} shared a plan with all their followers',
      achievement: 'You earned "{{name}}" ({{tier}})!',
      system: 'You have a system notification',
      progressionAnalysis: 'Your progression analysis is ready',
      achievementUnlocked: 'You unlocked a new achievement!',
      streakReset: 'You lost your streak. Start a new one today!',
      streakAtRisk_one: 'Your streak is at risk: {{count}} session left in {{days}}',
      streakAtRisk_other: 'Your streak is at risk: {{count}} sessions left in {{days}}',
      streakAtRiskGeneric: 'Your streak is at risk',
      days_one: '{{count}} day',
      days_other: '{{count}} days',
      membershipRenewed: 'Your membership was renewed successfully',
      membershipRenewalFailed: 'We could not renew your membership',
    },
    error: {
