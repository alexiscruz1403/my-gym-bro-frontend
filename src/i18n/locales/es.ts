const es = {
  ...
  notifications: {
    ...
    text: {
      ...
      postComment: '{{actor}} comentó: "{{preview}}"',
      postCommentNoText: '{{actor}} comentó tu post',
      newPost: '{{actor}} publicó un nuevo post',
      followRequest: '{{actor}} quiere seguirte',
      followAccepted: '{{actor}} aceptó tu solicitud de seguimiento',
      planSharedIndividual: '{{actor}} compartió un plan contigo',
      planSharedFollowers: '{{actor}} compartió un plan con todos sus seguidores',
      achievement: '¡Lograste "{{name}}" ({{tier}})!',
      system: 'Tenés una notificación del sistema',
      progressionAnalysis: 'Tu análisis de progresión ya está disponible',
      achievementUnlocked: '¡Desbloqueaste un nuevo logro!',
      streakReset: 'Perdiste tu racha. ¡Empezá una nueva hoy!',
      streakAtRisk_one: 'Tu racha está en riesgo: te falta {{count}} sesión en {{days}}',
      streakAtRisk_other: 'Tu racha está en riesgo: te faltan {{count}} sesiones en {{days}}',
      streakAtRiskGeneric: 'Tu racha está en riesgo',
      days_one: '{{count}} día',
      days_other: '{{count}} días',
      membershipRenewed: 'Tu membresía se renovó correctamente',
      membershipRenewalFailed: 'No pudimos renovar tu membresía',
    },
    error: {
